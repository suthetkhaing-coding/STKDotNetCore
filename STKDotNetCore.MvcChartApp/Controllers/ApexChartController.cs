...
using STKDotNetCore.MvcChartApp.Models;
...
namespace STKDotNetCore.MvcChartApp.Controllers
{
    public class ApexChartController : Controller
    {
        ...
        public IActionResult MixedLineColumnChart()
        {
            ...
            model.Series = new List<LineColumnChartSerieModel>();

            LineColumnChartSerieModel column = new LineColumnChartSerieModel
            {
                name = "Website Blog",
                type = "column",
            ...
            LineColumnChartSerieModel line = new LineColumnChartSerieModel
            {
                name = "Social Media",
                type = "line",
        ...
        public IActionResult GroupedBar()
        {
            ...
            GroupBarDataModel firstBar = new GroupBarDataModel();
            firstBar.data = new List<int> { 44, 55, 41, 64, 22, 43, 21 };

            GroupBarDataModel secBar = new GroupBarDataModel();
            secBar.data = new List<int> { 53, 32, 33, 52, 13, 44, 32 };

            model.BarGroup = new List<GroupBarDataModel> { firstBar, secBar };
        ...
        public IActionResult MultiSeriesTimelineChart()
        {
            var responseList = new List<MultiSeriesTimelineChartModel>
            {
                ...
                {
                    Name = "Bob",
                    Timelines = new List<TimelinesModel>
                    {
                        new()
                        {
                            Title = "Design",
        ...
        public IActionResult BasicColumnChart()
        {
            ...
            model.Series = new List<ColumnChartSeriesModel>
            {
        ...
        public IActionResult BasicSlopeChart()
        {
            BasicSlopeChartModel model = new BasicSlopeChartModel
            {
                ...
                Series = new List<SeriesDataModel>
                {
                    new SeriesDataModel
                    {
                        Name = "Blue",
                        Data = new List<DataPointModel>
                        {
                            new DataPointModel { Jan = "Jan", Feb = 43 },
                            new DataPointModel { Jan = "Feb", Feb = 58 }
                        }
                    },
                    new SeriesDataModel
                    {
                        ...
                        Data = new List<DataPointModel>
                        {
                            new DataPointModel { Jan = "Jan", Feb = 33 },
                            new DataPointModel { Jan = "Feb", Feb = 38 }
                        }
                    },
                    new SeriesDataModel
                    {
                        ...
                        Data = new List<DataPointModel>
                        {
                            new DataPointModel { Jan = "Jan", Feb = 55 },
                            new DataPointModel { Jan = "Feb", Feb = 21 }
                        }
                    }
                }
            };
        ...
        public IActionResult PyramidChart()
        {
            ...
            {
                Series = new List<PyramidChartSeriesDataModel>()
                {
                    new PyramidChartSeriesDataModel()
                    {
                        name="",
        ...
        {
            var seriesData = new List<StackedBarSeriesModel>
            {
                new StackedBarSeriesModel { name = "Marine Sprite", data = new List<int> { 44, 55, 41, 37, 22, 43, 21 } },
                new StackedBarSeriesModel { name = "Striking Calf", data = new List<int> { 53, 32, 33, 52, 13, 43, 32 } },
                new StackedBarSeriesModel { name = "Tank Picture", data = new List<int> { 12, 17, 11, 9, 15, 11, 20 } },
                new StackedBarSeriesModel { name = "Bucket Slope", data = new List<int> { 9, 7, 5, 8, 6, 9, 4 } },
                new StackedBarSeriesModel { name = "Reborn Kid", data = new List<int> { 25, 12, 19, 32, 25, 24, 10 } }
            };
        ...
        public IActionResult StackedColumns()
        {
            ...
            model.Series = new List<GroupModel>()
            {
                new GroupModel
                {
                    Name = "Product A",
