...
using STKDotNetCore.NLayer.DataAccess.Services;

namespace STKDotNetCore.NLayer.BusinessLogic.Services;
...
public class BL_Blog
{
    ...
    public int CreateBlog(string v, BlogModel requestModel)
    {
